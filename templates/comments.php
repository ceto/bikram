    ...
    <div class="columns">
      ...
      <nav>
        <ul class="pager">
          ...
          <li class="previous"><?php previous_comments_link(__('&larr; Older comments', 'bikram')); ?></li>
          <?php endif; ?>
          <?php if (get_next_comments_link()) : ?>
          <li class="next"><?php next_comments_link(__('Newer comments &rarr;', 'bikram')); ?></li>
          <?php endif; ?>
        </ul>
      </nav>
      <?php endif; ?>
      ...
      <div class="alert alert-warning">
        <?php _e('Comments are closed.', 'bikram'); ?>
      </div>
      <?php endif; ?>
      <?php comment_form(); ?>
    </div>
